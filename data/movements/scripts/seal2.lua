function onStepIn(cid, item, pos, fromPos)
 ...
 if isPlayer(cid) then
	if getPlayerStorageValue(cid,329970) == -1 and getfood1.itemid == 1946 and getfood2.itemid == 1946 and getfood3.itemid == 1946 and getfood4.itemid == 1946 and getfood5.itemid == 1945 and getfood6.itemid == 1945 then
		doTeleportThing(cid, {x=32261, y=31856, z=15})
		doSendMagicEffect(pos, 6)
		doSendMagicEffect(getThingPos(cid), 12)
		setPlayerStorageValue(cid,329970,1)
		setPlayerStorageValue(cid, 63592, 1)
		doPlayerSendTextMessage(cid,22,"You have finished the logic seal")
