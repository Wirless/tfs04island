...
doTargetCombatHealth(0, cid, COMBAT_POISONDAMAGE, -10, -10, CONST_ME_GREEN_RINGS)
doAddCondition(cid, poison)
 
elseif isInArray(ENERGY_FIELD, item.itemid) == 1 then
doTargetCombatHealth(0, cid, COMBAT_ENERGYDAMAGE, -60, ,60, CONST_ME_ENERGYHIT)
doAddCondition(cid, energy)
 
elseif isInArray(FIRE_FIELD_20, item.itemid) == 1 then
doTargetCombatHealth(0, cid, COMBAT_FIREDAMAGE, -40, -40, CONST_ME_HITBYFIRE)
