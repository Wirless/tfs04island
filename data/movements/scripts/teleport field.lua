...
Vangloria = {x=31736, y=32767, z=7}
	...
	elseif item.actionid == 4011 then
		THAISLIGHTHOUSE = {x=32225, y=32274, z=10}
	...
	elseif item.actionid == 4015 then
		doPlayerSetTown(cid, 13)
		doPlayerSendTextMessage(cid,22,"You are now a citizen of Vangloria!")
		doTeleportThing(cid,Vangloria)
		doSendMagicEffect(Vangloria,12)
