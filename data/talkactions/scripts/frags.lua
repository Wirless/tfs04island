    local config = {
    	fragTime = getConfigValue('TimeToDecreaseFrags')
    }
    ...
    function onSay(cid, words, param)
    	...
    	if(amount > 0 and config.fragTime > 0) then
    		...
    		doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "You have " .. frags .. " unjustified frag" .. (frags > 2 and "s" or "") .. ". The amount of one unjustified frag will decrease after: " .. hours .. "h and " .. minutes .. "m.")
    	else
