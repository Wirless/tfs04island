...
elseif ray_talk_state == 8595 and msgcontains(msg, 'yes') or ray_talk_state == 8595 and msgcontains(msg, 'Yes') then
...
elseif ray_talk_state == 8596 and msgcontains(msg, 'yes') or ray_talk_state == 8596 and msgcontains(msg, 'Yes') then
...
elseif ray_talk_state == 8595 and msgcontains(msg, '') then
npcHandler:say("Ok.", 1)
elseif ray_talk_state == 8596 and msgcontains(msg, '') then
npcHandler:say("Ok.", 1)
...
elseif  msgcontains(msg, 'mail') then
    ...
    ray_talk_state = 505   
        ...
        elseif ray_talk_state == 505 and msgcontains(msg, 'yes') then
		...
		ray_talk_state = 0
        elseif ray_talk_state == 505 and msgcontains(msg, 'no') then
