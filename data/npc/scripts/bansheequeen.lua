...
function creatureSayCallback(cid, type, msg)
	...
	local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and 0 or cid
    	...
    	-- Inicio The Queen of the Banshees NPC
            ...
            local primeiro_selo = getPlayerStorageValue(cid, 63591)
            local segundo_selo = getPlayerStorageValue(cid, 63592)
            local terceiro_selo = getPlayerStorageValue(cid, 63593)
            local quarto_selo = getPlayerStorageValue(cid, 63594)
            local quinto_selo = getPlayerStorageValue(cid, 63595)
            local sexto_selo = getPlayerStorageValue(cid, 63596)
            local setimo_selo = getPlayerStorageValue(cid, 63597)
    	...
    	elseif msgcontains(msg, 'yes') and talk_state == 1 then
			...
			doPlayerSendTextMessage(cid,22,"You have kissed the banshee")
			setPlayerStorageValue(cid, 63597, 1)
