...
keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "My name is Captain Henry from the Nordic Tibia Ferries."})
...
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Where do you want to go today? We serve the routes to Tibia."})
keywordHandler:addKeyword({'trip'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Where do you want to go today? We serve the routes to Tibia."})
...
keywordHandler:addKeyword({'island'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "We serve the routes to Tibia."})
keywordHandler:addKeyword({'route'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "We serve the routes to Tibia."})
keywordHandler:addKeyword({'iceona'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "This island is Iceona."})
...
--Travel in hurry--
if msgcontains(msg, "bring me to tibia") then
	Svensonbcprice = 0
