...
------MISSIONS-----
        ...
        elseif(msgcontains(msg:lower(),'yes')) and (npcHandlerfocus == 2) then
                    npcHandlerfocus = 0
                    setPlayerStorageValue(cid, 9032, 1)
					...
					doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "You completed the full green djinn quest.")

        elseif(msgcontains(msg:lower(),'permission')) and (getPlayerStorageValue(cid, 9032) == 1) then
