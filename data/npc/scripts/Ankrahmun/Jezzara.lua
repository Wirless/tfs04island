...
shopModule:addBuyableItem({'dragon ham'}, 					Cfdragonham, 25)
shopModule:addBuyableItem({'meat'}, 					Cfmeat, 10)
shopModule:addBuyableItem({'ham'}, 					Cfham, 15)
shopModule:addBuyableItem({'salmon'}, 					Cfsalmon, 7)
shopModule:addBuyableItem({'fish'}, 					Cffish, 6)
shopModule:addBuyableItem({'orange'}, 					Cforange, 9)
shopModule:addBuyableItem({'banana'}, 					Cfbanana, 5)
shopModule:addBuyableItem({'grape'}, 					Cfgrape, 8)
shopModule:addBuyableItem({'melon'}, 					Cfmelon, 13)
shopModule:addBuyableItem({'carrot'}, 					Cfcarrot, 8)
shopModule:addBuyableItem({'tomato'}, 					Cftomato, 10)
