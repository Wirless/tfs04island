...
shopModule:addBuyableItem({'bread'}, 					Cfbread, 8)
shopModule:addBuyableItem({'cheese'}, 					Cfcheese, 12)
shopModule:addBuyableItem({'meat'}, 					Cfmeat, 10)
shopModule:addBuyableItem({'ham'}, 					Cfham, 16)
shopModule:addBuyableItem({'fish'}, 					Cffish, 6)
shopModule:addBuyableItem({'lemonade'}, 					Cfmug, 3, 5, 'mug of lemonade')
shopModule:addBuyableItem({'wine'}, 					Cfmug, 4, 15, 'mug of wine')
