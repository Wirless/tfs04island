...
if msgcontains(msg, 'parcel') or msgcontains(msg, 'Parcel') then
	...
	jakahr_talk_state = 8595
	
elseif msgcontains(msg, 'letter') or msgcontains(msg, 'Letter') then
	itemname = "letter"
	itemprice = 5
	npcHandler:say("Would you like to buy a letter for 5 gold?", 1)
	jakahr_talk_state = 8596	
	
			
elseif jakahr_talk_state == 8595 and msgcontains(msg, 'yes') or jakahr_talk_state == 8595 and msgcontains(msg, 'Yes') then
...
elseif jakahr_talk_state == 8596 and msgcontains(msg, 'yes') or jakahr_talk_state == 8596 and msgcontains(msg, 'Yes') then
...
elseif jakahr_talk_state == 8595 and msgcontains(msg, '') then
npcHandler:say("Ok.", 1)
elseif jakahr_talk_state == 8596 and msgcontains(msg, '') then
npcHandler:say("Ok.", 1)
...
elseif  msgcontains(msg, 'mail') then
    ...
    jakahr_talk_state = 505   

        elseif jakahr_talk_state == 505 and msgcontains(msg, 'yes') then
		...
		jakahr_talk_state = 0
        elseif jakahr_talk_state == 505 and msgcontains(msg, 'no') then
