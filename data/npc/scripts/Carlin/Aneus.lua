...
npcHandler:say("The development of the city was fine. Also a giant castle was build northeast of the city. ...", 1)
npcHandler:say("But more and more workers started to rebel because of the bad conditions.", 5)
aneus_talk_state = 5

elseif aneus_talk_state == 5 and msgcontains(msg, 'rebel') and npcHandler.focus == cid then
npcHandler:say("All rebels were brought to the giant castle. Guarded by the Red Legion, they had to work and live in even worse conditions. ...", 1)
...
npcHandler:say("The king's sister was pretty upset about the situation there but her brother didn't want to do anything about this matter. ...", 1)
...
npcHandler:say("Most of the Red Legion went to the island by night. The orcs were not prepared and the Red Legion killed hundreds of orcs with nearly no loss. ...", 1)
...
npcHandler:say("It is said that the orcish shamans cursed the Red Legion. ...", 1)
npcHandler:say("Nobody knows. But one third of the soldiers died by a disease on the way back. ...", 5)
npcHandler:say("And the orcs wanted to take revenge, and after some days they stroke back! ...", 9)
npcHandler:say("The orcs and many allied cyclopses and minotaurs from all over Tibia came to avenge their friends, and they killed nearly all workers and soldiers in the castle. ...", 13)
...
npcHandler:say("She tried to rescue the workers but it was too late. The orcs started immediately to attack her troops, too. ...", 1)
...
npcHandler:say("They used the same trick as against the Red Legion and the orcs started to fight their non-orcish-allies. ...", 1)
npcHandler:say("After a bloody long fight the orcs went back to their cities. The city of Carlin was rescued. ...", 5)
npcHandler:say("Since then, a woman has always been ruling over Carlin and this statue was made to remind us of their great tactics against the orcs and the Red Legion. ...", 9)
