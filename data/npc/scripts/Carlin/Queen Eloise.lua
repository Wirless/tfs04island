...
if msgcontains(msg, 'promotion') or msgcontains(msg, 'promote') then
	npcHandler:say("Do you want to be promoted in your vocation for 10000 gold?", 1)
	queeneloise_talk_state = 2578	

elseif queeneloise_talk_state == 2578 and msgcontains(msg, 'yes') then
...
npcHandler:say("I remember about those uniforms, they had a camouflage inlay so they could be worn the inside out too. I will send some color samples via mail to Mr. Postner.", 1)
