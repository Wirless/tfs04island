...
shopModule:addBuyableItem({'lemonade'}, 					Cfbottle, 5, 5, 'bottle of refreshing lemonade')
shopModule:addBuyableItem({'milk'}, 					Cfbottle, 4, 6, 'bottle of our revitalizing milk')
shopModule:addBuyableItem({'water'}, 					Cfbottle, 2, 1, 'bottle of crystal clear water') 
