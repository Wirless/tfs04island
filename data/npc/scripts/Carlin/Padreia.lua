...
keywordHandler:addKeyword({'footnote'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "They thought they have to bring Crunor to the people, if people did not find to Crunor of their own. To achieve that they founded the inn Crunors Cottage, south of Mt. Sternum."})
...
if msgcontains(msg, 'footnote') then
	if getPlayerStorageValue(cid, 8191) == 2 then
		npcHandler:say("They thought they have to bring Crunor to the people, if people did not find to Crunor of their own. To achieve that they founded the inn Crunor's Cottage, south of Mt. Sternum.", 1)
		setPlayerStorageValue(cid,8191,3)
	elseif getPlayerStorageValue(cid, 8191) >= 2 then
		npcHandler:say("They thought they have to bring Crunor to the people, if people did not find to Crunor of their own. To achieve that they founded the inn Crunor's Cottage, south of Mt. Sternum.", 1)
	else
		npcHandler:say("I have to attend other business, ask later please.", 1)
	end
	padreia_talk_state = 0
end
