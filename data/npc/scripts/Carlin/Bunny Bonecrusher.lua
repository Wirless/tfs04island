...
elseif name_talk_state == 2 and msgcontains(msg, 'yes') and npcHandler.focus == cid then
	doSendMagicEffect(getCreaturePosition(getNpcId(  )), 13)
	doSendMagicEffect(getPlayerPosition(cid), 15)
	doAddCondition(cid, fire)
	npcHandler:say("Take this!", 0.5)
	name_talk_state = 0
elseif name_talk_state == 2 and msgcontains(msg, '') and npcHandler.focus == cid then
