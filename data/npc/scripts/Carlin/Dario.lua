...
elseif dario_talk_state == 8754 and msgcontains(msg, 'yes') then
	if isInArray(spellvoc, getPlayerVocation(cid)) == 1 then
...
elseif dario_talk_state == 8754 and msgcontains(msg, '') then
...
dario_talk_state = 859

elseif dario_talk_state == 859 and msgcontains(msg, 'yes') or dario_talk_state == 859 and msgcontains(msg, 'Yes') then
	if doPlayerRemoveMoney(cid, COUNTARROW*2) == TRUE then
	doPlayerAddItem(cid, Cfarrow, COUNTARROW)
...
elseif dario_talk_state == 859 and msgcontains(msg, '') then
