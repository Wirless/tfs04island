...
function greetCallback(cid)
	...
	npcHandler:setMessage(MESSAGE_GREET, "Well, hello there, Lady, ".. getPlayerName(cid) .." welcome to my humble furniture shop!")
	return true
	end	
end	
...
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I am Vangloria's foremost furniture salesman."})
...
keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "My name is Chuck."})
