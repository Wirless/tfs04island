...
keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "My name is Wally Joe, I don't know why I got that name, my mother gave it to me.."})
keywordHandler:addKeyword({'time'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "No idea. sorry."})
keywordHandler:addKeyword({'dungeon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I'm not very familiar with the dungeon, it's dangerus.. I think.."})
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I'm just a banker. working on a bank.. nothing special."})
keywordHandler:addKeyword({'how are you'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I'm fine, bit tired."})
...
keywordHandler:addKeyword({'oracle'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "She's at the second floor in the academy."})
keywordHandler:addKeyword({'vocation'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I think you'll have to speak with The Oracle for that."})
keywordHandler:addKeyword({'Tibia'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "This world is Tibia."})
keywordHandler:addKeyword({'Thais'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "A nice city, but I've only been there once, many many years ago."})
