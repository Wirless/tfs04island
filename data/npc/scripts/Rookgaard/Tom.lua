...
elseif tom_talk_state == 2 and msgcontains(msg, 'yes') then
...
elseif tom_talk_state == 2 and msgcontains(msg, '') then
...
elseif tom_talk_state == 3 and msgcontains(msg, 'yes') then
...
elseif tom_talk_state == 3 and msgcontains(msg, '') then
npcHandler:say("Maybe another time.", 1)
tom_talk_state = 0
...
elseif tom_talk_state == 4 and msgcontains(msg, 'yes') then
...
elseif tom_talk_state == 4 and msgcontains(msg, '') then
npcHandler:say("Maybe another time.", 1)
tom_talk_state = 0
