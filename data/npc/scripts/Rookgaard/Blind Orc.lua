...
elseif blindorc_talk_state == 103 and msgcontains(msg, 'mok') then
	if doPlayerRemoveMoney(cid, 85) == TRUE then
	npcHandler:say("Maruk rambo zambo!", 1)
	doPlayerAddItem(cid, Cfsword)
	blindorc_talk_state = 806
	else
	npcHandler:say("Maruk nixda!", 1)
	blindorc_talk_state = 806
	end
elseif blindorc_talk_state == 104 and msgcontains(msg, 'mok') then
	if doPlayerRemoveMoney(cid, 85) == TRUE then
	npcHandler:say("Maruk rambo zambo!", 1)
	doPlayerAddItem(cid, Cfhatchet)
	blindorc_talk_state = 806
	else
	npcHandler:say("Maruk nixda!", 1)
	blindorc_talk_state = 806
	end
elseif blindorc_talk_state == 105 and msgcontains(msg, 'mok') then
	if doPlayerRemoveMoney(cid, 25) == TRUE then
	npcHandler:say("Maruk rambo zambo!", 1)
	doPlayerAddItem(cid, Cfleatherarmor)
	blindorc_talk_state = 806
	else
	npcHandler:say("Maruk nixda!", 1)
	blindorc_talk_state = 806
	end	
elseif blindorc_talk_state == 106 and msgcontains(msg, 'mok') then
	if doPlayerRemoveMoney(cid, 90) == TRUE then
	npcHandler:say("Maruk rambo zambo!", 1)
	doPlayerAddItem(cid, Cfstuddedarmor)
	blindorc_talk_state = 806
	else
	npcHandler:say("Maruk nixda!", 1)
	blindorc_talk_state = 806
	end	
elseif blindorc_talk_state == 107 and msgcontains(msg, 'mok') then
	if doPlayerRemoveMoney(cid, 60) == TRUE then
	npcHandler:say("Maruk rambo zambo!", 1)
	doPlayerAddItem(cid, Cfstuddedhelmet)
	blindorc_talk_state = 806
	else
	npcHandler:say("Maruk nixda!", 1)
	blindorc_talk_state = 806
	end	
elseif blindorc_talk_state == 108 and msgcontains(msg, 'mok') then
	if doPlayerRemoveMoney(cid, 65) == TRUE then
	npcHandler:say("Maruk rambo zambo!", 1)
	doPlayerAddItem(cid, Cfbrassshield)
	blindorc_talk_state = 806
	else
	npcHandler:say("Maruk nixda!", 1)
	blindorc_talk_state = 806
	end	
elseif blindorc_talk_state == 109 and msgcontains(msg, 'mok') then
	if doPlayerRemoveMoney(cid, 400) == TRUE then
	npcHandler:say("Maruk rambo zambo!", 1)
	doPlayerAddItem(cid, Cfbow)
	blindorc_talk_state = 806
	else
	npcHandler:say("Maruk nixda!", 1)
	blindorc_talk_state = 806
	end	
elseif blindorc_talk_state == 110 and msgcontains(msg, 'mok') then
	if doPlayerRemoveMoney(cid, 30) == TRUE then
	npcHandler:say("Maruk rambo zambo!", 1)
	doPlayerAddItem(cid, Cfarrow, 10)
	blindorc_talk_state = 806
	else
	npcHandler:say("Maruk nixda!", 1)
	blindorc_talk_state = 806
