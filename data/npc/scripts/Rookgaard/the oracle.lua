...
function oracle(cid, message, keywords, parameters, node)
	...
	local function sorcererDruidItems(cid)
		...
		doAddContainerItem(backpack, Cfrope, 1)
		doAddContainerItem(backpack, 7091, 1)
		doAddContainerItem(backpack, 7099, 1)
		doAddContainerItem(backpack, 7100, 1)
		doAddContainerItem(backpack, 2152, 5) -- 5 platinum coin
	end
	...
	local function paladinItems(cid)
		...
		doAddContainerItem(backpack, Cfrope, 1)
		doAddContainerItem(backpack, Cfshovel, 1)
		doAddContainerItem(backpack, Cfbow, 1)
		doAddContainerItem(backpack, Cfarrow, 100)
		doAddContainerItem(backpack, 2152, 5) -- 5 platinum coin
	end
	
	local function knightItems(cid)
		backpack = doPlayerAddItem(cid, 1988, 1)
		doAddContainerItem(backpack, Cfplatearmor, 1) -- brass armor
		doAddContainerItem(backpack, Cfplatelegs, 1) -- brass legs
		doAddContainerItem(backpack, Cfspikesword, 1) -- weapon
		doAddContainerItem(backpack, Cfbarbarianaxe, 1) -- weapon
		doAddContainerItem(backpack, Cfclericalmace, 1) -- weapon
		doAddContainerItem(backpack, Cfdragonshield, 1) -- copper shield
		doAddContainerItem(backpack, Cfrope, 1)
		doAddContainerItem(backpack, Cfshovel, 1)
		doAddContainerItem(backpack, 2152, 5) -- 5 platinum coin
	end
