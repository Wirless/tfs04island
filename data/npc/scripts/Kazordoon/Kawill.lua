...
elseif msgcontains(msg, 'spaaaaaark') or msgcontains(msg, 'phoaasfgenix') then
	...
	kawill_talk_state = 1394


elseif kawill_talk_state == 1394 and msgcontains(msg, 'yes') then
	if getCreatureStorage(cid, 1339) <= 0 then
	doCreatureSetStorage(cid, 1339, 1)
...
elseif kawill_talk_state == 1394 and msgcontains(msg, '') then
