...
shopModule:addBuyableItem({'meat'}, 					Cfmeat, 6)
shopModule:addBuyableItem({'bread'}, 					Cfbread, 4)
shopModule:addBuyableItem({'beer'}, 					Cfmug, 5, 3)
shopModule:addBuyableItem({'wine'}, 					Cfmug, 6, 15)
shopModule:addBuyableItem({'water'}, 					Cfmug, 0, 1)
