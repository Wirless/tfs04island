...
shopModule:addBuyableItem({'orange'}, 					Cforange, 7)
shopModule:addBuyableItem({'banana'}, 					Cfbanana, 3)
shopModule:addBuyableItem({'grape'}, 					Cfgrape, 5)
shopModule:addBuyableItem({'melon'}, 					Cfmelon, 10)
shopModule:addBuyableItem({'carrot'}, 					Cfcarrot, 4)
shopModule:addBuyableItem({'tomato'}, 					Cftomato, 5)
