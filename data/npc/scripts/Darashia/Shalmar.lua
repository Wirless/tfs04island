...
elseif msgcontains(msg, 'energy beam') or msgcontains(msg, 'Energy beam') then
	...
	spellmagiclevel = 10
		...
		elseif msgcontains(msg, 'ice strike') or msgcontains(msg, 'ice strike') then
	spellprice = 800
	spellvoc = {1, 2, 5, 6}
	...
	spellmagiclevel = 3
		...
		elseif msgcontains(msg, 'terra strike') or msgcontains(msg, 'terra strike') then
	spellprice = 800
	spellvoc = {1, 2, 5, 6}
	...
	spellmagiclevel = 3
		...
		elseif msgcontains(msg, 'terra wave') or msgcontains(msg, 'Terra wave') then
	spellprice = 2500
	spellvoc = {2, 6}
...
elseif msgcontains(msg, 'great fireball') or msgcontains(msg, 'Great fireball') then
	...
	elseif msgcontains(msg, 'thunderstorm') or msgcontains(msg, 'thunderstorm rune') then
	spellprice = 1200
	spellvoc = {1, 5}
...
elseif msgcontains(msg, 'avalanche') or msgcontains(msg, 'avalanche rune') then
	spellprice = 1200
	spellvoc = {2, 6}
	spellname = "avalanche"
	spellmagiclevel = 9
...
elseif msgcontains(msg, 'stoneshower') or msgcontains(msg, 'stoneshower rune') then
	spellprice = 1200
	spellvoc = {2, 6}
	spellname = "stoneshower rune"
	spellmagiclevel = 9
		if isInArray(spellvoc, getPlayerVocation(cid)) then
		npcHandler:say("Do you want to learn the spell '".. spellname .."' for ".. spellprice .." gold?", 1)
		talk_state = 8754
...
elseif msgcontains(msg, 'antidote') or msgcontains(msg, 'cure poison') then
	spellprice = 150
	spellvoc = {1, 2, 3, 4, 5, 6, 7, 8}
...
elseif msgcontains(msg, 'spell') then
	...
	npcHandler:say("for you, I sell 'terra wave', 'ice strike', 'terra strike', 'Find Person', 'Light', 'Create Food', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field' and. ...", 1)
