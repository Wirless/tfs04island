...
elseif shalmarl_talk_state == 8754 and msgcontains(msg, 'yes') then
	if isInArray(spellvoc, getPlayerVocation(cid)) == 1 then
...
elseif shalmarl_talk_state == 8754 and msgcontains(msg, '') then
