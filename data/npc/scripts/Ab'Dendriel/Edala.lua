...
elseif msgcontains(msg, 'fire') or msgcontains(msg, 'sun') then
	npcHandler:say("Do you wish to receive the blessing of the two suns? It will cost you 40.000 gold, pilgrim.", 1)
	edala_talk_state = 1394


elseif edala_talk_state == 1394 and msgcontains(msg, 'yes') then
	if doPlayerRemoveMoney(cid, 40000) == true then
		if doPlayerAddBlessing(cid, 3) == true then
...
elseif edala_talk_state == 1394 and msgcontains(msg, '') then
