...
if msgcontains(msg, 'key') or msgcontains(msg, 'Key') then
	...
	shirith_talk_state = 1
			
elseif shirith_talk_state == 1 and msgcontains(msg, 'yes') or shirith_talk_state == 1 and msgcontains(msg, 'Yes') then
	...
	shirith_talk_state = 0

elseif shirith_talk_state == 1 and msgcontains(msg, '') then
