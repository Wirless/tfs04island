...
shopModule:addBuyableItem({'crossbow'}, 					Cfcrossbow, 450)
shopModule:addBuyableItem({'bow'}, 					Cfbow, 350)
...
elseif irea_talk_state == 859 and msgcontains(msg, 'yes') or irea_talk_state == 859 and msgcontains(msg, 'Yes') then
...
elseif irea_talk_state == 859 and msgcontains(msg, '') then
