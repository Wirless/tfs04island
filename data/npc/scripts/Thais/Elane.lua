...
elseif msgcontains(msg, 'invisible') or msgcontains(msg, 'Invisible') then
	...
	spellmagiclevel = 15
		...
		elseif msgcontains(msg, 'holy strike') or msgcontains(msg, 'Holy strike') then
	spellprice = 1500
	spellvoc = {3, 7}
...
npcHandler:say("I sell 'holy strike', 'find person', 'light', 'create food', 'light healing', 'light magic missile', 'antidote', 'intense healing', 'conjure arrow', 'great light', 'heavy magic missile', 'magic shield' and. ...", 1)
