...
elseif bozo_talk_state == 1 and msgcontains(msg, '') then
...
elseif msgcontains(msg, 'jester') or msgcontains(msg, 'fool') then
	...
	bozo_talk_state = 6
elseif bozo_talk_state == 6 and msgcontains(msg, 'yes') then	
	npcHandler:say("Sorry, you already are a member.", 1)
	bozo_talk_state = 0
elseif bozo_talk_state == 6 and msgcontains(msg, '') then	
...
elseif bozo_talk_state == 3 and msgcontains(msg, 'yes') then	
	...
	bozo_talk_state = 0
elseif bozo_talk_state == 3 and msgcontains(msg, '') then	
...
elseif bozo_talk_state == 2 and msgcontains(msg, 'yes') then	
	...
	bozo_talk_state = 0	
elseif bozo_talk_state == 2 and msgcontains(msg, '') then	
...
elseif bozo_talk_state == 5 and msgcontains(msg, 'yes') then
	npcHandler:say("This is a world of fantasy and full of surprises!", 1)
	bozo_talk_state = 0
elseif bozo_talk_state == 5 and msgcontains(msg, '') then
...
elseif bozo_talk_state == 4 and msgcontains(msg, 'yes') then
	doSendMagicEffect(getCreaturePosition(getNpcId(  )), 14)
	npcHandler:say("Uh, oh! ... I am seeing stars!", 1)
	bozo_talk_state = 0
elseif bozo_talk_state == 4 and msgcontains(msg, '') then
