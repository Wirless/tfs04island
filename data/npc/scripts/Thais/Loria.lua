...
elseif loria_talk_state == 1 and msgcontains(msg, 'find person') then
	npcHandler:say("Say the words: exiva 'name'", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'light healing') then
	npcHandler:say("Say the word: exura", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'light magic missile') then
	npcHandler:say("Say the word: adori", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'antidote') then
	npcHandler:say("Say the words: exana pox", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'intense healing') then
	npcHandler:say("Say the words: exura gran", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'poison field') then
	npcHandler:say("Say the words: adevo grav pox", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'great light') then
	npcHandler:say("Say the words: utevo gran lux", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'fire field') then
	npcHandler:say("Say the words: adevo grav flam", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'heavy magic missile') then
	npcHandler:say("Say the words: adori gran", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'magic shield') then
	npcHandler:say("Say the words: utamo vita", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'energy field') then
	npcHandler:say("Say the words: adevo grav vis", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'destroy field') then
	npcHandler:say("Say the words: adito grav", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'fire wave') then
	npcHandler:say("Say the words: exevo flam hur", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'ultimate healing') then
	npcHandler:say("Say the words: exura vita", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'great fireball') then
	npcHandler:say("Say the words: adori gran flam", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'fire bomb') or loria_talk_state == 1 and msgcontains(msg, 'firebomb') then
	npcHandler:say("Say the words: adevo mas flam", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'creature illusion') then
	npcHandler:say("Say the words: utevo res ina 'creature'", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'poison wall') then
	npcHandler:say("Say the words: adevo mas grav pox", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'explosion') then
	npcHandler:say("Say the words: adevo mas hur", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'fire wall') then
	npcHandler:say("Say the words: adevo mas grav flam", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'great energy beam') then
	npcHandler:say("Say the words: exevo gran vis lux", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'invisible') then
	npcHandler:say("Say the words: utana vid", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'summon creature') then
	npcHandler:say("Say the words: utevo res 'creature'", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'energy wall') then
	npcHandler:say("Say the words: adevo mas grav vis", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'energy wave') then
	npcHandler:say("Say the words: exevo mort hur", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'sudden death') then
	npcHandler:say("Say the words: adori vita vis", 1)			
elseif loria_talk_state == 1 and msgcontains(msg, 'energy beam') then
	npcHandler:say("Say the words: exevo vis lux", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'fireball') then
	npcHandler:say("Say the words: adori flam", 1)		
elseif loria_talk_state == 1 and msgcontains(msg, 'light') then
	npcHandler:say("Say the words: utevo lux", 1)		
	
	
elseif loria_talk_state == 4 and msgcontains(msg, 'spell') or msgcontains(msg, 'Spell') then
