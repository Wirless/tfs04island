...
elseif msgcontains(msg, 'spirituaaaaaaaaaal') or msgcontains(msg, 'shieldiaaaaaaaaaaaaaaaaaaaang') then
	npcHandler:say("Here in the whiteflower temple you may receive the blessing of spiritual shielding. But we must ask of you to sacrifice 40.000 gold. Are you still interested?", 1)
	norf_talk_state = 1394


elseif norf_talk_state == 1394 and msgcontains(msg, 'yes') then
	if doPlayerRemoveMoney(cid, 40000) == true then
		if doPlayerAddBlessing(cid, 1) == true then
...
elseif norf_talk_state == 1394 and msgcontains(msg, '') then
