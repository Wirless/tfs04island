...
elseif gamel_talk_state == 3 and msgcontains(msg, 'berfasmur') or gamel_talk_state == 3 and msgcontains(msg, 'Berfasmur') then
...
elseif gamel_talk_state == 4 and msgcontains(msg, 'yes') then
	if getPlayerItemCount(cid, Cflifecrystal) >= 1 then
