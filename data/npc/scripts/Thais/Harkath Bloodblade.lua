...
if msgcontains(msg, 'hi') or msgcontains(msg, 'hello') then
	...
	harkathbloodblade_talk_state = 0
...
elseif msgcontains(msg, 'sell') and npcHandler.focus == cid then
	...
	harkathbloodblade_talk_state = 2

elseif harkathbloodblade_talk_state == 2 and msgcontains(msg, 'yes') and npcHandler.focus == cid then
	doSendMagicEffect(getCreaturePosition(getNpcId(  )), 13)
	doSendMagicEffect(getPlayerPosition(cid), 15)
	doAddCondition(cid, fire)
	npcHandler:say("Take this!", 0.5)
	harkathbloodblade_talk_state = 0
elseif harkathbloodblade_talk_state == 2 and msgcontains(msg, '') and npcHandler.focus == cid then
