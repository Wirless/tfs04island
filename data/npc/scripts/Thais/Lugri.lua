...
elseif lugri_talk_state == 2 and msgcontains(msg, 'good') or lugri_talk_state == 2 and msgcontains(msg, 'light') then
	npcHandler:say("The so called gods of good are Fardos, Uman, the elements, Suon, Crunor, Nornur, Bastesh, Kirok, Toth, and Banor.", 1)
	lugri_talk_state = 0	
elseif lugri_talk_state == 2 and msgcontains(msg, 'tibia') or lugri_talk_state == 2 and msgcontains(msg, 'Tibia') then
	npcHandler:say("Tibia is just the mindless elemental power of earth.", 1)
	lugri_talk_state = 0	
elseif lugri_talk_state == 2 and msgcontains(msg, 'evil') or lugri_talk_state == 2 and msgcontains(msg, 'darkness') then
...
elseif lugri_talk_state == 1 and msgcontains(msg, 'yes') then
	...
	lugri_talk_state = 0
elseif lugri_talk_state == 1 and msgcontains(msg, '') then
...
elseif msgcontains(msg, 'death to noodles') then
	...
	lugri_talk_state = 3
elseif lugri_talk_state == 3 and msgcontains(msg, 'yes') then
	if doPlayerRemoveItem(cid, Cflifecrystal, 1) == TRUE then
	doPlayerAddItem(cid, Cflifering, 1)
	end
