...
baxter_talk_state = 1
elseif baxter_talk_state == 1 and msgcontains(msg, "fruit") then
npcHandler:say("I understand he was stealing some fruit, he is obsessed with, and got incautious.", 1)
baxter_talk_state = 0
elseif baxter_talk_state == 1 and msgcontains(msg, "") then
...
elseif baxter_talk_state == 2 and msgcontains(msg, 'yes') then
...
elseif baxter_talk_state == 2 and msgcontains(msg, '') then
