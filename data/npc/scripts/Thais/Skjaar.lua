...
function greetCallback(cid)
	...
	elseif getPlayerLevel(cid) >= 15 then
...
elseif GetTalkState(cid) == 1 and msgcontains(msg, 'yes') or GetTalkState(cid) == 1 and msgcontains(msg, 'Yes') then
	...
	TalkState(cid, 2)
elseif GetTalkState(cid) == 1 and msgcontains(msg, 'no') then
	npcHandler:say("Then leave, unworthy worm!", 1)
	TalkState(cid, 0)	
elseif GetTalkState(cid) == 1 and msgcontains(msg, '') then
	npcHandler:say("You're not worthy if you cannot make up your mind. Leave!", 1)
	TalkState(cid, 0)
	npcHandler:releaseFocus()
	npcHandler:resetNpc()	
	
elseif GetTalkState(cid) == 2 and msgcontains(msg, 'yes') or GetTalkState(cid) == 2 and msgcontains(msg, 'Yes') then
...
elseif GetTalkState(cid) == 2 and msgcontains(msg, 'no') then
	npcHandler:say("Then leave, unworthy worm!", 1)
	TalkState(cid, 0)	
elseif GetTalkState(cid) == 2 and msgcontains(msg, '') then
	npcHandler:say("You're not worthy if you cannot make up your mind. Leave!", 1)
	TalkState(cid, 0)
	npcHandler:releaseFocus()
	npcHandler:resetNpc()	
	
elseif GetTalkState(cid) == 3 and msgcontains(msg, 'redips') or GetTalkState(cid) == 2 and msgcontains(msg, 'Redips') then
	npcHandler:say("Perhaps you knew him after all. Tell me - how many fingers did he have when he died?", 1)
	TalkState(cid, 4)
elseif GetTalkState(cid) == 3 and msgcontains(msg, '') then
	npcHandler:say("You are wrong. Get lost!", 1)
	TalkState(cid, 0)
	npcHandler:releaseFocus()
	npcHandler:resetNpc()
	
elseif GetTalkState(cid) == 4 and msgcontains(msg, '7') or GetTalkState(cid) == 4 and msgcontains(msg, 'seven') or GetTalkState(cid) == 4 and msgcontains(msg, 'Seven') then
	npcHandler:say("Also true. But can you also tell me the colour of the deamons in which master specialized?", 1)
	TalkState(cid, 5)
elseif GetTalkState(cid) == 4 and msgcontains(msg, '') then
	npcHandler:say("You are wrong. Get lost!", 1)
	TalkState(cid, 0)
	npcHandler:releaseFocus()
	npcHandler:resetNpc()	
	
elseif GetTalkState(cid) == 5 and msgcontains(msg, 'black') or GetTalkState(cid) == 5 and msgcontains(msg, 'Black') then
	npcHandler:say("It seems you are worthy after all. Do you want the key to the crypt?", 1)
	TalkState(cid, 6)
elseif GetTalkState(cid) == 5 and msgcontains(msg, '') then
	npcHandler:say("You are wrong. Get lost!", 1)
	TalkState(cid, 0)
	npcHandler:releaseFocus()
	npcHandler:resetNpc()	
	
elseif GetTalkState(cid) == 6 and msgcontains(msg, 'yes') or GetTalkState(cid) == 6 and msgcontains(msg, 'Yes') then
	NOBLEARMORKEY = doPlayerAddItem(cid, 2089, 1)
	doSetItemActionId(NOBLEARMORKEY, 2015)
	doSetItemSpecialDescription(NOBLEARMORKEY, "(Key: 3142)")
	npcHandler:say("Here you are.", 1)
	TalkState(cid, 0)
elseif GetTalkState(cid) == 6 and msgcontains(msg, '') then
