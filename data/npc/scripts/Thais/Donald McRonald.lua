...
function onThink() 						npcHandler:onThink() end
	...
	FOCUS_FAREWELLSWORDS = {'codexqwabteuse'}
...
elseif msgcontains(msg, 'spider') then
	...
	donaldmcronald_talk_state = 2
	
elseif donaldmcronald_talk_state == 2 and msgcontains(msg, 'yes') then
...
elseif donaldmcronald_talk_state == 2 and msgcontains(msg, '') then
