...
if aruda_talk_state == 1 and msgcontains(msg, '') and npcHandler.focus == cid then
...
elseif aruda_talk_state == 4 and msgcontains(msg, 'spouse') and npcHandler.focus == cid or aruda_talk_state == 4 and msgcontains(msg, 'girlfriend') and npcHandler.focus == cid then
	npcHandler:say("Well ... I  might have known him a little .. but there was nothing serious.", 1)
	aruda_talk_state = 5	

elseif aruda_talk_state == 5 and msgcontains(msg, 'fruit') and npcHandler.focus == cid then
