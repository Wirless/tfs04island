	...
	function ShopModule:parseBuyable(data)
		for item in string.gmatch(data, '[^;]+') do
			...
			if(name ~= nil and itemid ~= nil and cost ~= nil) then
				if((isItemRune(itemid) == TRUE or isItemFluidContainer(itemid) == TRUE or isItemChargeAmulet(itemid) == TRUE or isItemChargeRing(itemid) == TRUE) and charges == nil) then
...
function ShopModule:buyContainer(names, container, itemid, cost, charges, realname)
                for i, name in pairs(names) do
                        ...
                        if(isItemFluidContainer(itemid) == TRUE or isItemChargeAmulet(itemid) == TRUE or isItemChargeRing(itemid) == TRUE) then
