...
doSendAnimatedText(getPlayerPosition(cid), "XP+", TEXTCOLOR_GREEN)
doSendAnimatedText(getPlayerPosition(cid), "XP+++++", TEXTCOLOR_LIGHTBLUE)
doSendAnimatedText(getPlayerPosition(cid), "XP+++", TEXTCOLOR_RED)
doSendAnimatedText(getPlayerPosition(cid), "XP+++++", TEXTCOLOR_WHITE)
end
...
if item.uid == 7006 then
	...
	setPlayerStorageValue(cid,7006,1)
        ...
        doSetItemUniqueId(item.uid, 65530)
		if addXP == 1 then
doPlayerAddExperience(cid, 100*XPM)
makeffect(cid)
end
	else
...
elseif item.uid == 7010 then
	...
	if addXP == 1 then
doPlayerAddExperience(cid, 1000*XPM)
makeffect(cid)
end
        doSetItemActionId(item.uid, 0)
        doSetItemUniqueId(item.uid, 65530)
...
elseif item.uid == 7014 then
	...
	setPlayerStorageValue(cid,7014,1) if addXP == 1 then
doPlayerAddExperience(cid, 1000*XPM)
makeffect(cid)
end
	else
...
elseif item.uid == 7019 then
	...
	setPlayerStorageValue(cid,7019,1) if addXP == 1 then
doPlayerAddExperience(cid, 1000*XPM)
makeffect(cid)
end
        doSetItemActionId(item.uid, 0)
...
elseif item.uid == 7020 then
	...
	setPlayerStorageValue(cid,7020,1) if addXP == 1 then
doPlayerAddExperience(cid, 1000*XPM)
makeffect(cid)
end
        doSetItemActionId(item.uid, 0)
...
elseif item.uid == 7023 then
	...
	setPlayerStorageValue(cid,7023,1) if addXP == 1 then
doPlayerAddExperience(cid, 1000*XPM)
makeffect(cid)
end
        doSetItemActionId(item.uid, 0)
