...
elseif item.uid == 8002 then
	if getPlayerStorageValue(cid,8002) <= 0 then
...
elseif item.uid == 8006 then
	if getPlayerStorageValue(cid,8006) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 50000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8010 then
	if getPlayerStorageValue(cid,8010) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 20000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8011 then
	if getPlayerStorageValue(cid,8011) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 1000000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8016 then
	if getPlayerStorageValue(cid,8016) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 100000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8022 then
	if getPlayerStorageValue(cid,8022) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 60000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8023 then
	if getPlayerStorageValue(cid,8023) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 200000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8025 then
	if getPlayerStorageValue(cid,8025) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 30000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8028 then
	if getPlayerStorageValue(cid,8028) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 300000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8042 then
	if getPlayerStorageValue(cid,8042) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 40000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8051 then
	if getPlayerStorageValue(cid,8051) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 250000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8058 then
	if getPlayerStorageValue(cid,8058) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 15000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8068 then
	if getPlayerStorageValue(cid,8068) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 70000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8070 then
	if getPlayerStorageValue(cid,8070) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 44000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8076 then
	if getPlayerStorageValue(cid,8076) <= 0 then
		...
		doPlayerSendTextMessage(cid,22,"You have found a mercenary shield.")
...
elseif item.uid == 8080 then
	if getPlayerStorageValue(cid,8080) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 7000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8088 then
	if getPlayerStorageValue(cid,8088) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 400000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
makeffect(cid)
		...
		---FIX
		DEMONPOS1 = {x=33059, y=31623, z=15}
		DEMONPOS2 = {x=33067, y=31623, z=15}
		DEMONPOS3 = {x=33058, y=31629, z=15}
		DEMONPOS4 = {x=33068, y=31629, z=15}
...
elseif item.uid == 8102 then
	if getPlayerStorageValue(cid,8102) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 8000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8103 then
	if getPlayerStorageValue(cid,8103) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 90000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8106 then
	if getPlayerStorageValue(cid,8106) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 55000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8116 then
	if getPlayerStorageValue(cid,8116) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 6000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8117 then
	if getPlayerStorageValue(cid,8117) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 5000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8133 then
	if getPlayerStorageValue(cid,8133) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 80000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8138 then
	if getPlayerStorageValue(cid,8138) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 500000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8139 then
	if getPlayerStorageValue(cid,8139) <= 0 then
		...
		doPlayerAddItem(cid, Cfstoneskinamulet, 1)
...
elseif item.uid == 8140 then
	if getPlayerStorageValue(cid,8140) <= 0 then
		...
		doPlayerAddItem(cid, Cfstealthring, 1)
...
elseif item.uid == 25302 then
	if getPlayerStorageValue(cid,25302) <= 0 then
		if getPlayerFreeCap(cid) <= 10 then
		doPlayerSendTextMessage(cid,22,"You need 10 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 25303 then
	if getPlayerStorageValue(cid,25303) <= 0 then
		if getPlayerFreeCap(cid) <= 8 then
		doPlayerSendTextMessage(cid,22,"You need 8 cap or more to loot this!")
		return TRUE
		end
		...
		setPlayerStorageValue(cid,25303,1)
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
	end
-----
...
elseif item.uid == 8148 then
	if getPlayerStorageValue(cid,8148) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 3000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8160 then
	if getPlayerStorageValue(cid,8160) <= 0 then
		...
		if addXP == 1 then
doPlayerAddExperience(cid, 5000000*XPM)
makeffect(cid)
end
	else
	doPlayerSendTextMessage(cid,22,"it's empty.")
...
elseif item.uid == 8203 then
	if getPlayerStorageValue(cid,8203) <= 0 then
		...
		doPlayerSendTextMessage(cid,22,"You have 32 talons!")
...
elseif item.uid == 8206 then
	if getPlayerStorageValue(cid,8206) <= 0 then
		...
		doPlayerSendTextMessage(cid,22,"You have found a piece of a helmet!")
...
elseif item.uid == 8211 then
	if getPlayerStorageValue(cid,8211) <= 0 then
		...
		doPlayerSendTextMessage(cid,22,"You need 0 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a piece of a helmet!")
...
elseif item.uid == 8220 then
	if getPlayerStorageValue(cid,8220) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a copper key!")
		KEY = doPlayerAddItem(cid, Cfcopperkey, 1)
		doSetItemActionId(KEY, 3301)
		setPlayerStorageValue(cid,8220,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 100000*XPM)
makeffect(cid)
end
...
elseif item.uid == 8221 then
	if getPlayerStorageValue(cid,8221) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a copper key!")
		KEY = doPlayerAddItem(cid, Cfcopperkey, 1)
		doSetItemActionId(KEY, 3302)
		setPlayerStorageValue(cid,8221,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 100000*XPM)
makeffect(cid)
end
...
elseif item.uid == 8222 then
	if getPlayerStorageValue(cid,8222) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
		...
		setPlayerStorageValue(cid,8222,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 100000*XPM)
makeffect(cid)
end
...
elseif item.uid == 8223 then
	if getPlayerStorageValue(cid,8223) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a copper key!")
		KEY = doPlayerAddItem(cid, 2091, 1)
		doSetItemActionId(KEY, 3304)
		setPlayerStorageValue(cid,8223,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 100000*XPM)
makeffect(cid)
end
...
elseif item.uid == 10059 then
	if getPlayerStorageValue(cid,10059) <= 0 then
		if getPlayerFreeCap(cid) <= 8 then
		doPlayerSendTextMessage(cid,22,"You need 8 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 10058 then
	if getPlayerStorageValue(cid,10058) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 10060 then
	if getPlayerStorageValue(cid,10060) <= 0 then
		if getPlayerFreeCap(cid) <= 10 then
		doPlayerSendTextMessage(cid,22,"You need 10 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a silver dagger!")
...
elseif item.uid == 8224 then
	if getPlayerStorageValue(cid,8224) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
...
elseif item.uid == 8225 then
	if getPlayerStorageValue(cid,8225) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a ice sword!")
		doPlayerAddItem(cid, 5739, 1)
		setPlayerStorageValue(cid,8225,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 100000*XPM)
makeffect(cid)
end
...
elseif item.uid == 8226 then -- Dragon Lord Mountain Quest
	if getPlayerStorageValue(cid,8226) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a ice sword!")
		doPlayerAddItem(cid, 5739, 1)
		setPlayerStorageValue(cid,8226,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 100000*XPM)
makeffect(cid)
end
...
elseif item.uid == 8227 then -- Hellfire Fighter Quest
	if getPlayerStorageValue(cid,8227) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a ice sword!")
		doPlayerAddItem(cid, 5739, 1)
		setPlayerStorageValue(cid,8227,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 10000*XPM)
makeffect(cid)
end
...
elseif item.uid == 8228 then -- Undead Dragon Quest
	if getPlayerStorageValue(cid,8228) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a ice sword!")
		doPlayerAddItem(cid, 5739, 1)
		setPlayerStorageValue(cid,8228,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 10000*XPM)
makeffect(cid)
end
...
elseif item.uid == 8229 then -- Undead Dragon Quest
	if getPlayerStorageValue(cid,8229) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a ice sword!")
		doPlayerAddItem(cid, 5739, 1)
		setPlayerStorageValue(cid,8229,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 10000*XPM)
makeffect(cid)
end
...
elseif item.uid == 8230 then -- Behemoth Quest
	if getPlayerStorageValue(cid,8230) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a ice sword!")
		doPlayerAddItem(cid, 5739, 1)
		setPlayerStorageValue(cid,8230,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 10000*XPM)
makeffect(cid)
end
...
elseif item.uid == 8231 then -- Demon Quest
	if getPlayerStorageValue(cid,8231) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a ice sword!")
		doPlayerAddItem(cid, 5739, 1)
		setPlayerStorageValue(cid,8231,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 10000*XPM)
makeffect(cid)
end
...
elseif item.uid == 8232 then -- Hero Quest
	if getPlayerStorageValue(cid,8232) <= 0 then
		if getPlayerFreeCap(cid) <= 23 then
		doPlayerSendTextMessage(cid,22,"You need 23 cap or more to loot this!")
		return TRUE
		end
		doPlayerSendTextMessage(cid,22,"You have found a ice sword!")
		doPlayerAddItem(cid, 5739, 1)
		setPlayerStorageValue(cid,8232,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 10000*XPM)
makeffect(cid)
end
...
-----
-- Skull Quest(Amazon Camp floor +1) --
elseif item.uid == 8233 then
	if getPlayerStorageValue(cid,8233) <= 0 then
		if getPlayerFreeCap(cid) <= 50 then
		doPlayerSendTextMessage(cid,22,"You need 50 cap or more to loot this!")
		return TRUE
		end
		...
		doAddContainerItem(BAG, Cfgoldcoin, 100)
		doAddContainerItem(BAG, Cfcrystalnecklace, 1)
		setPlayerStorageValue(cid,8233,1)
		if addXP == 1 then
doPlayerAddExperience(cid, 10000*XPM)
makeffect(cid)
end
...
-- Desert Library Key --
elseif item.uid == 8234 then
	if getPlayerStorageValue(cid,8234) <= 0 then
		if getPlayerFreeCap(cid) <= 1 then
		doPlayerSendTextMessage(cid,22,"You need 1 cap or more to loot this!")
		return TRUE
		end
