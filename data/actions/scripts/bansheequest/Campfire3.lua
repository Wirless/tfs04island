...
if item.uid == 63507 and item.itemid == 1945 and getTileItemById(gatepos, 1423).uid > 0 then
...
elseif item.uid == 63507 and item.itemid == 1946 and getTileItemById(gatepos, 1421).uid > 0 then
