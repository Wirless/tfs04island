...
if item.uid == 63508 and item.itemid == 1945 and getTileItemById(gatepos, 1423).uid > 0 then
doRemoveItem(getTileItemById(gatepos, 1423).uid)
doCreateItem(1421,1,gatepos)
doTransformItem(item.uid,1946)
e = addEvent(f, time * 1000, fromPosition)
 
elseif item.uid == 63508 and item.itemid == 1946 and getTileItemById(gatepos, 1421).uid > 0 then
