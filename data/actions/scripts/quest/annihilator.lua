...
if item.uid == 5000 then
 ...
 player1pos = {x=33125, y=31824, z=13, stackpos=253}
 player1 = getThingfromPos(player1pos)

 player2pos = {x=33124, y=31824, z=13, stackpos=253}
 player2 = getThingfromPos(player2pos)

 player3pos = {x=33123, y=31824, z=13, stackpos=253}
 player3 = getThingfromPos(player3pos)

 player4pos = {x=33122, y=31824, z=13, stackpos=253}
 player4 = getThingfromPos(player4pos)
  ...
  if player1level >= questlevel and player2level >= questlevel and player3level >= questlevel and player4level >= questlevel then
	...
	--if 1==1 then
	demon1pos = {x=33119, y=31810, z=13}
	demon2pos = {x=33121, y=31810, z=13}
	demon3pos = {x=33120, y=31814, z=13}
	demon4pos = {x=33122, y=31814, z=13}
	demon5pos = {x=33123, y=31812, z=13}
	demon6pos = {x=33124, y=31812, z=13}
   ...
   doSummonCreature("Demon", demon6pos)
	...
	nplayer1pos = {x=33122, y=31812, z=13}
	nplayer2pos = {x=33121, y=31812, z=13}
	nplayer3pos = {x=33120, y=31812, z=13}
	nplayer4pos = {x=33119, y=31812, z=13}
