...
#define CLIENT_VERSION_STRING "Only Avangarde client Allowed!"
#else
...
#define SOFTWARE_NAME "0.5.6"
#define SOFTWARE_VERSION "OTS"
#define SOFTWARE_CODENAME "-"
#define SOFTWARE_DEVELOPERS "TFS Developers"
#if defined(__PROTOCOL_77__)
