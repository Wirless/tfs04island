...
class RuneSpell : public Action, public Spell
{
	...
	protected:
		...
		static RuneSpellFunction ForceConvince;
		static RuneSpellFunction Soulfire;
		//Test script weapontype from combat fetch static InstantSpellFunction Whirlwindthrow; or try to declare local variables inside the lua of spell and change based on getplayerslot?
