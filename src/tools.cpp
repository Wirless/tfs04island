...
MagicEffectNames magicEffectNames[] =
{
	...
	{"newmortarea",			MAGIC_EFFECT_NEW_SUDDENDEATH},
	...
	{"energyarea",		MAGIC_EFFECT_ENERGYAREA},
	...
	{"confettihorizontal",	MAGIC_EFFECT_CONFETTI_HORIZONTAL},
	{"confettivertical",	MAGIC_EFFECT_CONFETTI_VERTICAL},
	{"blacksmoke",		MAGIC_EFFECT_BLACKSMOKE},
	{"skullrx",			MAGIC_EFFECT_SKULLRX},
	{"pogchamp",		MAGIC_EFFECT_POGCHAMP}
};
...
ShootTypeNames shootTypeNames[] =
{
	...
	{"sword",			SHOOT_EFFECT_SWORD},
	{"axe",				SHOOT_EFFECT_AXE},
	{"club",			SHOOT_EFFECT_CLUB},
	{"espear",			SHOOT_EFFECT_ETHEREALSPEAR},
	{"frigo",			SHOOT_EFFECT_FRIGO},
	{"terra",			SHOOT_EFFECT_TERRA},
	{"san",				SHOOT_EFFECT_SAN},
	{"deathx",			SHOOT_EFFECT_DEATHX},
	{"arrowvis",		SHOOT_EFFECT_ARROWVIS},
	{"arrowfire",		SHOOT_EFFECT_ARROWFIRE},
	{"arrowice",		SHOOT_EFFECT_ARROWICE},
	{"visdx",			SHOOT_EFFECT_VISDX},
	{"frigox",			SHOOT_EFFECT_FRIGOX},
	{"holysan",			SHOOT_EFFECT_HOLYSAN},
	{"earthx",			SHOOT_EFFECT_EARTHX},
	{"assassinstar",	SHOOT_EFFECT_ASSASSINSTAR}
...
AmmoTypeNames ammoTypeNames[] =
{
	...
	//vizjus	{"assassinstar",	AMMO_ASSASSINSTAR}
};
...
//damageprint and combateffect vizjus420
void getCombatDetails(CombatType_t combatType, MagicEffect_t& magicEffect, Color_t& textColor)
{
	switch(combatType)
	{
		...
		{
			textColor = COLOR_LIGHTBLUE; //test
		...
		{// breaks remember to use them because it seems you dont have them vizjuss.... // ICEBLUE
				textColor = COLOR_TEAL; //"icearea",		MAGIC_EFFECT_ICEAREA
				magicEffect = MAGIC_EFFECT_ICEATTACK; //42
				break;
		}
		
		case COMBAT_HOLYDAMAGE:
		{//this would be used its commented with the ICEATTACK was instead set to ICEDAMAGE open your eyes ya bollocks
				textColor = COLOR_YELLOW; //yellow
				magicEffect = MAGIC_EFFECT_HOLYDAMAGE; //"holydamage",		MAGIC_EFFECT_HOLYDAMAGE}
				break;
		}
		//420420 
...
std::string getReason(int32_t reasonId)
{
	switch(reasonId)
	{
		...
		case 1:
			return "name containing part of sentence";
		case 2:
			return "name with nonsensical letter combo";
		case 3:
			return "invalid name format";
		case 4:
			return "name not describing person";
		case 5:
			return "name of celebrity";
		case 6:
			return "name referring to country";
		case 7:
			return "namefaking player identity";
		case 8:
			return "namefaking official position";
		case 9:
			return "offensive statement";
		case 10:
			return "spamming";
		case 11:
			return "advertisement not related to game";
		case 12:
			return "real money advertisement";
		case 13:
		...
		case 25:
			return "pretending to have official position";
		case 26:
			return "pretending to have influence on gamemaster";
		case 27:
			return "false report to gamemaster";
		case 28:
			return "excessive unjustifed player killing";
		case 29:
