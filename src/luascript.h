...
class LuaInterface
{
	...
	protected:
		...
		static int32_t luaDoForceConvinceCreature(lua_State* L);
		...
		//static int32_t luaDoCreatureForceAddMana(lua_State* L);
		static int32_t luaSetCreatureMaxHealth(lua_State* L);
		static int32_t luaSetCreatureHealth(lua_State* L);
		static int32_t luaSetCreatureMaxMana(lua_State* L);
		static int32_t luaSetCreatureMana(lua_State* L);
		//static int32_t luaSetCreatureBoostMana(lua_State* L);
